...
enum {
	...
	ERR_GENERAL             = 1,
	ERR_UNEXPECED_EOF       = 2,
	ERR_UNEXPECTED_CHAR     = 3,
	ERR_UNEXPECTED_SYMBOL   = 4,
	ERR_UNCLOSED_STRING     = 5,
	ERR_UNCLOSED_COMMENT    = 6,
	ERR_INVALID_LITERAL     = 7,
	ERR_INVALID_ID          = 8,
	ERR_STRINGS_UNSUPORTED  = 9,
	ERR_STRING_TOO_LONG     = 10,
	ERR_STRING_NOT_FOUND    = 11,
	ERR_STRBUF_OVERFLOW     = 12,
	ERR_SYNTAX_ERROR        = 13,
	ERR_DATA_OVERFLOW       = 14,
	ERR_VAR_UNKNOWN         = 15,
	ERR_EXTERN_UNKNOWN      = 16,
	ERR_ARG_MISSING         = 17,
	ERR_TOO_MANY_ARGS       = 18,
	ERR_SYM_PUSH_FAIL       = 19,
	ERR_SYM_POP_FAIL        = 20,
	ERR_OBJ_NEW_FAIL        = 21,
	ERR_SDT_STACK_OVERFLOW  = 22,
	...
	ERR_ATTR_NOT_ARRAY      = 35,
	ERR_NULL_POINTER        = 36,
	ERR_EXTERN_NOT_SCALAR   = 37,
	ERR_NOT_FUNCTION        = 38,
	ERR_NOT_VARIABLE        = 39,
